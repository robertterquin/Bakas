    ...
    >
      <div className="w-full max-w-md bg-slate-900 border border-slate-700 rounded-t-3xl sm:rounded-3xl shadow-2xl p-6 text-slate-100 space-y-5">
            ...
            {RADIUS_OPTIONS.map((opt) => {
              ...
              return (
                <button
                  ...
                  className={`w-full p-3 rounded-2xl border flex items-center justify-between transition-all focus-visible:ring-2 focus-visible:ring-sky-400 ${
                    isSelected
        ...
        <button
          type="button"
          onClick={onClose}
          className="w-full py-3 rounded-2xl bg-white text-slate-950 font-bold text-sm hover:bg-slate-100 transition-colors"
        >
          Apply Filters
        </button>
      </div>
